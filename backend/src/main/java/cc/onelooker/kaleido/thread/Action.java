...
public enum Action {
    ...
    musicSync("同步Plex音乐库"), musicReadAudioTag("读取音乐标签"), musicDownloadLyric("下载歌词"),

    tvshowSync("同步剧集库"), tvshowUpdateSource("更新剧集源"), tvshowMatchInfo("匹配信息"), tvshowWriteNFO("写入NFO"),

    comicSync("漫画同步"), comicUpdateSource("漫画更新源"), comicMatchInfo("匹配抓取"), comicWriteComicInfo("写入ComicInfo"), tableOptimize("优化数据库");
