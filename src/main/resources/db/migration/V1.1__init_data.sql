...
values (1, 'writeMovieNFO', 'writeMovieNFO', '1', 0, now(), now(), 'system', 'system');

insert into sys_config (id, config_name, config_key, config_value, is_deleted, create_time,
                        update_time, created_by, updated_by)
values (2, 'writeTvshowNFO', 'writeTvshowNFO', '1', 0, now(), now(), 'system', 'system');

insert into sys_config (id, config_name, config_key, config_value, is_deleted, create_time,
                        update_time, created_by, updated_by)
values (3, 'writeAudioTag', 'writeAudioTag', '1', 0, now(), now(), 'system', 'system');

insert into sys_config (id, config_name, config_key, config_value, is_deleted, create_time,
                        update_time, created_by, updated_by)
values (4, 'writeComicInfo', 'writeComicInfo', '1', 0, now(), now(), 'system', 'system');

insert into sys_config (id, config_name, config_key, config_value, is_deleted, create_time,
                        update_time, created_by, updated_by)
values (5, 'refreshMetadata', 'refreshMetadata', '1', 0, now(), now(), 'system', 'system');
